...
card(chemical_elements, "Ac", "Actinium (89)").
card(chemical_elements, "Ag", "Silver (47)").
card(chemical_elements, "Al", "Aluminium (13)").
card(chemical_elements, "Am", "Americium (95)").
card(chemical_elements, "Ar", "Argon (18)").
card(chemical_elements, "As", "Arsenic (33)").
card(chemical_elements, "At", "Astatine (85)").
card(chemical_elements, "Au", "Gold (79)").
card(chemical_elements, "B", "Boron (5)").
card(chemical_elements, "Ba", "Barium (56)").
card(chemical_elements, "Be", "Beryllium (4)").
card(chemical_elements, "Bh", "Bohrium (107)").
card(chemical_elements, "Bi", "Bismuth (83)").
card(chemical_elements, "Bk", "Berkelium (97)").
card(chemical_elements, "Br", "Bromine (35)").
card(chemical_elements, "C", "Carbon (6)").
card(chemical_elements, "Ca", "Calcium (20)").
card(chemical_elements, "Cd", "Cadmium (48)").
card(chemical_elements, "Ce", "Cerium (58)").
card(chemical_elements, "Cf", "Californium (98)").
card(chemical_elements, "Cl", "Chlorine (17)").
card(chemical_elements, "Cm", "Curium (96)").
card(chemical_elements, "Cn", "Copernicium (112)").
card(chemical_elements, "Co", "Cobalt (27)").
card(chemical_elements, "Cr", "Chromium (24)").
card(chemical_elements, "Cs", "Caesium (55)").
card(chemical_elements, "Cu", "Copper (29)").
card(chemical_elements, "Db", "Dubnium (105)").
card(chemical_elements, "Ds", "Darmstadtium (110)").
card(chemical_elements, "Dy", "Dysprosium (66)").
card(chemical_elements, "Er", "Erbium (68)").
card(chemical_elements, "Es", "Einsteinium (99)").
card(chemical_elements, "Eu", "Europium (63)").
card(chemical_elements, "F", "Fluorine (9)").
card(chemical_elements, "Fe", "Iron (26)").
card(chemical_elements, "Fl", "Flerovium (114)").
card(chemical_elements, "Fm", "Fermium (100)").
card(chemical_elements, "Fr", "Francium (87)").
card(chemical_elements, "Ga", "Gallium (31)").
card(chemical_elements, "Gd", "Gadolinium (64)").
card(chemical_elements, "Ge", "Germanium (32)").
card(chemical_elements, "H", "Hydrogen (1)").
card(chemical_elements, "He", "Helium (2)").
card(chemical_elements, "Hf", "Hafnium (72)").
card(chemical_elements, "Hg", "Mercury (80)").
card(chemical_elements, "Ho", "Holmium (67)").
card(chemical_elements, "Hs", "Hassium (108)").
card(chemical_elements, "I", "Iodine (53)").
card(chemical_elements, "In", "Indium (49)").
card(chemical_elements, "Ir", "Iridium (77)").
card(chemical_elements, "K", "Potassium (19)").
card(chemical_elements, "Kr", "Krypton (36)").
card(chemical_elements, "La", "Lanthanum (57)").
card(chemical_elements, "Li", "Lithium (3)").
card(chemical_elements, "Lr", "Lawrencium (103)").
card(chemical_elements, "Lu", "Lutetium (71)").
card(chemical_elements, "Lv", "Livermorium (116)").
card(chemical_elements, "Mc", "Moscovium (115)").
card(chemical_elements, "Md", "Mendelevium (101)").
card(chemical_elements, "Mg", "Magnesium (12)").
card(chemical_elements, "Mn", "Manganese (25)").
card(chemical_elements, "Mo", "Molybdenum (42)").
card(chemical_elements, "Mt", "Meitnerium (109)").
card(chemical_elements, "N", "Nitrogen (7)").
card(chemical_elements, "Na", "Sodium (11)").
card(chemical_elements, "Nb", "Niobium (41)").
card(chemical_elements, "Nd", "Neodymium (60)").
card(chemical_elements, "Ne", "Neon (10)").
card(chemical_elements, "Nh", "Nihonium (113)").
card(chemical_elements, "Ni", "Nickel (28)").
card(chemical_elements, "No", "Nobelium (102)").
card(chemical_elements, "Np", "Neptunium (93)").
card(chemical_elements, "O", "Oxygen (8)").
card(chemical_elements, "Og", "Oganesson (118)").
card(chemical_elements, "Os", "Osmium (76)").
card(chemical_elements, "P", "Phosphorus (15)").
card(chemical_elements, "Pa", "Protactinium (91)").
card(chemical_elements, "Pb", "Lead (82)").
card(chemical_elements, "Pd", "Palladium (46)").
card(chemical_elements, "Pm", "Promethium (61)").
card(chemical_elements, "Po", "Polonium (84)").
card(chemical_elements, "Pr", "Praseodymium (59)").
card(chemical_elements, "Pt", "Platinum (78)").
card(chemical_elements, "Pu", "Plutonium (94)").
card(chemical_elements, "Ra", "Radium (88)").
card(chemical_elements, "Rb", "Rubidium (37)").
card(chemical_elements, "Re", "Rhenium (75)").
card(chemical_elements, "Rf", "Rutherfordium (104)").
card(chemical_elements, "Rg", "Roentgenium (111)").
card(chemical_elements, "Rh", "Rhodium (45)").
card(chemical_elements, "Rn", "Radon (86)").
card(chemical_elements, "Ru", "Ruthenium (44)").
card(chemical_elements, "S", "Sulfur (16)").
card(chemical_elements, "Sb", "Antimony (51)").
card(chemical_elements, "Sc", "Scandium (21)").
card(chemical_elements, "Se", "Selenium (34)").
card(chemical_elements, "Sg", "Seaborgium (106)").
card(chemical_elements, "Si", "Silicon (14)").
card(chemical_elements, "Sm", "Samarium (62)").
card(chemical_elements, "Sn", "Tin (50)").
card(chemical_elements, "Sr", "Strontium (38)").
card(chemical_elements, "Ta", "Tantalum (73)").
card(chemical_elements, "Tb", "Terbium (65)").
card(chemical_elements, "Tc", "Technetium (43)").
card(chemical_elements, "Te", "Tellurium (52)").
card(chemical_elements, "Th", "Thorium (90)").
card(chemical_elements, "Ti", "Titanium (22)").
card(chemical_elements, "Tl", "Thallium (81)").
card(chemical_elements, "Tm", "Thulium (69)").
card(chemical_elements, "Ts", "Tennessine (117)").
card(chemical_elements, "U", "Uranium (92)").
card(chemical_elements, "V", "Vanadium (23)").
card(chemical_elements, "W", "Tungsten (74)").
card(chemical_elements, "Xe", "Xenon (54)").
card(chemical_elements, "Y", "Yttrium (39)").
